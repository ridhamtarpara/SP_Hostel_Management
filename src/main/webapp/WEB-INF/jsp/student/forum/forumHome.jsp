...
<section class="content-header">
	<h1>
		Discussion Forum(${course}<i class="fa fa-long-arrow-right"></i>${subcourse})</h1>
</section>
<section class="content">
	<div class="row">
		<div class="col-xs-12">
			<a href="<c:url value='/student/forum/postQuestion'/>"><button
					class="btn btn-success proceedbtn">Post Question</button></a>
