...
<div id="about" class="container">
	<h1 class="sectionhead">Library</h1>
	<p>A huge 24 X 7 hours open library is provided in both the
		hostels. It is well lighted and ventilated. It provides a peaceful
		environment to the students to achieve their respective goals. Some
		novels, magazine and books are also available to borrow and read to
		acquire more than bookish knowledge.</p>
	<div id="slider1_container"
		...
		<div u="slides"
			...
			<div>
				<img u="image" src="<c:url value='/dist/img/library/1.jpg'/>"
					alt="Library"> <img u="thumb"
					src="<c:url value='/dist/img/library/1.jpg'/>">
			</div>
			<div>
				<img u="image" src="<c:url value='/dist/img/library/2.jpg'/>">
				<img u="thumb" src="<c:url value='/dist/img/library/2.jpg'/>">
			</div>
			<div>
				<img u="image" src="<c:url value='/dist/img/library/3.jpg'/>">
				<img u="thumb" src="<c:url value='/dist/img/library/3.jpg'/>">
			</div>
			<div>
				<img u="image" src="<c:url value='/dist/img/library/4.jpg'/>">
				<img u="thumb" src="<c:url value='/dist/img/library/4.jpg'/>">
			</div>
			<div>
				<img u="image" src="<c:url value='/dist/img/library/5.jpg'/>">
				<img u="thumb" src="<c:url value='/dist/img/library/5.jpg'/>">
			</div>
		</div>
