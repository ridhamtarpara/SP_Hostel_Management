...
<div id="about" class="container">
	<h1 class="sectionhead">Tuition</h1>
	<p>As good strength of students and reference of Trustee is
		available so students need not go to the institutes or classes,
		Tuition classes are held in the campus only. Tuitions for 11th & 12th
		are held on campus. Even consultancy of competitive Examination like
		GPSC, UPSC are given.</p>
	<p>For Girls, various classes like Art of Living, Grooming, Spoken
		English etc are held in campus only.</p>
	<div id="slider1_container"
		...
		<div u="slides"
			...
			<div>
				<img u="image" src="img/Dining/1.jpg" alt="Tuition Room"> <img
					u="thumb" src="img/Dining/1.jpg">
			</div>
			<div>
				<img u="image" src="img/Dining/2.jpg"> <img u="thumb"
					src="img/Dining/2.jpg">
			</div>
			<div>
				<img u="image" src="img/Dining/3.jpg"> <img u="thumb"
					src="img/Dining/3.jpg">
			</div>
			<div>
				<img u="image" src="img/Dining/4.jpg"> <img u="thumb"
					src="img/Dining/4.jpg">
			</div>
			<div>
				<img u="image" src="img/Dining/5.jpg"> <img u="thumb"
					src="img/Dining/5.jpg">
			</div>
		</div>
