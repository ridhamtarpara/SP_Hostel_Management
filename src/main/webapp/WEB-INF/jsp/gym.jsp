...
<div id="about" class="container">
	<h1 class="sectionhead">Gym</h1>
	<p>Boys can be in good shape and maintain their strength by the gym
		facility provided which has almost every needed equipments.</p>
	<p>As far as girls are considered, yoga can be practiced by them in
		the hall way provided on every floor.</p>
	<div id="slider1_container"
		...
		<div u="slides"
			...
			<div>
				<img u="image" src="img/Dining/1.jpg" alt="room1"> <img
