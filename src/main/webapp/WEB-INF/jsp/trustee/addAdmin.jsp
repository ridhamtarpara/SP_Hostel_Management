		...
		<form action="" class="form-horizontal" method="post"
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<div class="control-group">
						<div class="controls col-sm-6">
							<spring:bind path="admin.qualifications">
								<input id="qualification" class="form-control"
									name="${status.expression}" value="${status.value}"
									placeholder="Qualifications" required="required"
									data-validation-required-message="Please Enter Qualification" />
							</spring:bind>
						</div>
					</div>
				</div>
						...
						<div class="controls col-sm-6">
							<spring:bind path="users.nativeZipCode">
								<input class="form-control" name="${status.expression}"
									value="${status.value}" placeholder="Native PIN Code"
									required="required"
									data-validation-regex-regex="^([3])([0-9]){5}$"
									data-validation-regex-message="Enter Valid Pincode" />
							</spring:bind>
