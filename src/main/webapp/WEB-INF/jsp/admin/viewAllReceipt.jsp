...
<div class="row">
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<div class="box-body">
			<form class="form-horizontal" action="<c:url value="/admin/receipt"/>" method="post">
				<div class="form-group">
							<label class="col-sm-3 control-label">Receipt Type</label>
							<div class="control-group">
								<div class="controls col-sm-6">
									<select class="form-control" name="type"
										...
										<option value="shree donation">Shree Donation</option>
										<option value="food bill">Food Fill</option>
